...
Describe 'New-AzDataProtectionBackupInstance' {
    It '__AllParameterSets' {
        ...
        $instance  = Search-AzDataProtectionBackupInstanceInAzGraph -Subscription $sub -DatasourceType AzureDatabaseForPostgreSQL -ResourceGroup $rgName -Vault $vaultName 
