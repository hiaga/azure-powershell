...
INPUTOBJECT <IDataProtectionIdentity>: Identity Parameter
  ...
  [VaultName <String>]: The name of the backup vault.
.Link
https://docs.microsoft.com/powershell/module/az.dataprotection/get-azdataprotectionbackupinstanceoperationresult
#>
function Get-AzDataProtectionBackupInstanceOperationResult {
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DataProtection.private\Get-AzDataProtectionBackupInstanceOperationResult_Get';
            GetViaIdentity = 'Az.DataProtection.private\Get-AzDataProtectionBackupInstanceOperationResult_GetViaIdentity';
        }
...
INPUTOBJECT <IDataProtectionIdentity>: Identity Parameter
  ...
  [VaultName <String>]: The name of the backup vault.
.Link
https://docs.microsoft.com/powershell/module/az.dataprotection/get-azdataprotectionoperationstatusbackupvaultcontext
#>
function Get-AzDataProtectionOperationStatusBackupVaultContext {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220401.IOperationResource])]
[CmdletBinding(DefaultParameterSetName='Get', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
    [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Category('Path')]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DataProtection.private\Get-AzDataProtectionOperationStatusBackupVaultContext_Get';
            GetViaIdentity = 'Az.DataProtection.private\Get-AzDataProtectionOperationStatusBackupVaultContext_GetViaIdentity';
        }
        if (('Get') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
...
INPUTOBJECT <IDataProtectionIdentity>: Identity Parameter
  ...
  [VaultName <String>]: The name of the backup vault.
.Link
https://docs.microsoft.com/powershell/module/az.dataprotection/get-azdataprotectionoperationstatusresourcegroupcontext
#>
function Get-AzDataProtectionOperationStatusResourceGroupContext {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20220401.IOperationResource])]
[CmdletBinding(DefaultParameterSetName='Get', PositionalBinding=$false)]
param(
    [Parameter(ParameterSetName='Get', Mandatory)]
...
begin {
    try {
        ...
        $mapping = @{
            Get = 'Az.DataProtection.private\Get-AzDataProtectionOperationStatusResourceGroupContext_Get';
            GetViaIdentity = 'Az.DataProtection.private\Get-AzDataProtectionOperationStatusResourceGroupContext_GetViaIdentity';
        }
        if (('Get') -contains $parameterSet -and -not $PSBoundParameters.ContainsKey('SubscriptionId')) {
            $PSBoundParameters['SubscriptionId'] = (Get-AzContext).Subscription.Id
        }
...
INPUTOBJECT <IDataProtectionIdentity>: Identity Parameter
  ...
  [VaultName <String>]: The name of the backup vault.
.Link
https://docs.microsoft.com/powershell/module/az.dataprotection/resume-azdataprotectionbackupinstancebackup
#>
function Resume-AzDataProtectionBackupInstanceBackup {
[OutputType([System.Boolean])]
...
begin {
    try {
        ...
        $mapping = @{
            Resume = 'Az.DataProtection.private\Resume-AzDataProtectionBackupInstanceBackup_Resume';
            ResumeViaIdentity = 'Az.DataProtection.private\Resume-AzDataProtectionBackupInstanceBackup_ResumeViaIdentity';
        }
...
begin {
    try {
        ...
        $mapping = @{
            Sync = 'Az.DataProtection.private\Sync-AzDataProtectionBackupInstance_Sync';
            SyncExpanded = 'Az.DataProtection.private\Sync-AzDataProtectionBackupInstance_SyncExpanded';
            SyncViaIdentity = 'Az.DataProtection.private\Sync-AzDataProtectionBackupInstance_SyncViaIdentity';
            SyncViaIdentityExpanded = 'Az.DataProtection.private\Sync-AzDataProtectionBackupInstance_SyncViaIdentityExpanded';
        }
