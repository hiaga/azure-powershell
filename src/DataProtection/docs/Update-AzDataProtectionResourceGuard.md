...
```
Update-AzDataProtectionResourceGuard -Name <String> -ResourceGroupName <String> [-DefaultProfile <PSObject>]
 [-ETag <String>] [-IdentityType <String>] [-SubscriptionId <String>] [-Tag <Hashtable>]
 [-VaultCriticalOperationExclusionList <String[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
