...
Module Guid: ba5feff5-66db-4569-bb06-1aa44aeb1d8b
...
### [Get-AzDataProtectionBackupInstanceOperationResult](Get-AzDataProtectionBackupInstanceOperationResult.md)
...
### [Get-AzDataProtectionOperationStatusBackupVaultContext](Get-AzDataProtectionOperationStatusBackupVaultContext.md)
Gets the operation status for an operation over a BackupVault's context.

### [Get-AzDataProtectionOperationStatusResourceGroupContext](Get-AzDataProtectionOperationStatusResourceGroupContext.md)
...
### [Resume-AzDataProtectionBackupInstanceBackup](Resume-AzDataProtectionBackupInstanceBackup.md)
