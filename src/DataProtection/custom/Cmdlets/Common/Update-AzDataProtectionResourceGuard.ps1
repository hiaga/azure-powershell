...
{   
    ...
    param(
        ...
        [Parameter(ParameterSetName="UpdateResourceGuardOperations", Mandatory=$false, HelpMessage='List of critical operations which are not protected by this resourceGuard')]
        [System.String[]]
    ...
    process
    {
        ...
        if($ResGuard -eq $null){
            $errormsg = "ResourceGuard not Found"
    		throw $errormsg
        }
