function Initialize-AzDataProtectionRestoreRequest
{
    ...
    {         
        ...
        # DppRef: check what all attributes $PsCmdlet has - huge object. Remove later
        # Write-Host ($PsCmdlet | ConvertTo-Json -Depth 2)
        ...
        else 
        {
            ...
            # DppRef: check if DatasourceType condition is needed
