...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.IScheduleBasedBackupCriteria[]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.IBackupPolicy
Parameter Sets: (All)
Aliases:
