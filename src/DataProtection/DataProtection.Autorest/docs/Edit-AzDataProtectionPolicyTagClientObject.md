...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.IScheduleBasedBackupCriteria[]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.IBackupPolicy
Parameter Sets: (All)
Aliases:
