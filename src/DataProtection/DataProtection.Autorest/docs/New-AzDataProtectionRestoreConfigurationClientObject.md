...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.KubernetesClusterRestoreCriteriaNamespaceMappings
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.NamespacedNameResource[]
Parameter Sets: (All)
Aliases:
