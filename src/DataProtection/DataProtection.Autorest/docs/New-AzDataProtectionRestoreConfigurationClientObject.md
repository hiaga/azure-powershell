...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.KubernetesClusterRestoreCriteriaNamespaceMappings
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.NamespacedNameResource[]
Parameter Sets: (All)
Aliases:
