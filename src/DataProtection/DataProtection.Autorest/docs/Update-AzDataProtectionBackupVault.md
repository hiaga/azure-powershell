...
Update-AzDataProtectionBackupVault -ResourceGroupName <String> -VaultName <String> [-SubscriptionId <String>]
 ...
 [-EncryptionSettingInfrastructureEncryption <InfrastructureEncryptionState>]
 [-EncryptionSettingState <EncryptionState>] [-IdentityType <String>]
 [-IdentityUserAssignedIdentity <Hashtable>] [-ImmutabilityState <ImmutabilityState>]
 [-KekIdentityId <String>] [-KekIdentityType <IdentityType>] [-KeyVaultPropertyKeyUri <String>]
...
### -EncryptionSettingInfrastructureEncryption
...
### -KekIdentityId
The managed identity to be used which has access permissions to the Key Vault.
...
### -KekIdentityType
The identity type.
'SystemAssigned' and 'UserAssigned' are mutually exclusive.
...
### Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.IBackupVaultResource
