...
function GetDatasourceSetInfo
{
	...
	param(
		...
		[Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.IDatasource]
		$DatasourceInfo,
	...
	process 
	{
		$DataSourceSetInfo = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.DatasourceSet]::new()
...
function GetDatasourceInfo
{
	...
	{
		$manifest = LoadManifest -DatasourceType $DatasourceType.ToString()
		$DataSourceInfo = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.Datasource]::new()
