...
function GetDatasourceSetInfo
{
	...
	param(
		...
		[Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.IDatasource]
		$DatasourceInfo,
	...
	process 
	{
		$DataSourceSetInfo = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.DatasourceSet]::new()
...
function GetDatasourceInfo
{
	...
	{
		$manifest = LoadManifest -DatasourceType $DatasourceType.ToString()
		$DataSourceInfo = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.Datasource]::new()
