...
function New-AzDataProtectionRestoreConfigurationClientObject{
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.KubernetesClusterRestoreCriteriaNamespaceMappings]
        ${NamespaceMapping},
    ...
    process {
        $restoreCriteria =  [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.KubernetesClusterRestoreCriteria]::new()
