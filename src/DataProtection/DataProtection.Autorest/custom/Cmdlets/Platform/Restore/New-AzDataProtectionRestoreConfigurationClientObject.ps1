...
function New-AzDataProtectionRestoreConfigurationClientObject{
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.KubernetesClusterRestoreCriteriaNamespaceMappings]
        ${NamespaceMapping},
    ...
    process {
        $restoreCriteria =  [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.KubernetesClusterRestoreCriteria]::new()
