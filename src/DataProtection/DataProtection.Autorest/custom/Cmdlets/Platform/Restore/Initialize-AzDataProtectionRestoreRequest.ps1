...
{
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.IAzureBackupRestoreRequest')]
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.BackupInstanceResource]
        ${BackupInstance},
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.KubernetesClusterRestoreCriteria]
    ...
    {         
        ...
        {               
            ...
            if($PSBoundParameters.ContainsKey("RehydrationPriority")){
                $restoreRequest = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.AzureBackupRestoreWithRehydrationRequest]::new()
                ...
                $restoreRequest = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.AzureBackupRecoveryPointBasedRestoreRequest]::new()
        ...
        elseif(($PointInTime -ne $null)  -and ($PointInTime -ne "")) # RecoveryPointInTimeBasedRestore
        {
            ...
            $restoreRequest = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.AzureBackupRecoveryTimeBasedRestoreRequest]::new()
        ...
        {
           $restoreRequest.RestoreTargetInfo = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.RestoreFilesTargetInfo]::new()
        ...
        {   
            ...
            if($DatasourceType -ne "AzureKubernetesService"){
                $restoreRequest.RestoreTargetInfo = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.RestoreTargetInfo]::new()
                $restoreRequest.RestoreTargetInfo.ObjectType = "restoreTargetInfo"
            }
            else{
                $restoreRequest.RestoreTargetInfo = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.ItemLevelRestoreTargetInfo]::new()
            ...
            if($DatasourceType -ne "AzureKubernetesService"){
                ...
                if(($RecoveryPoint -ne $null) -and ($RecoveryPoint -ne "") -and $ContainersList.length -gt 0){
                    for($i = 0; $i -lt $ContainersList.length; $i++){
                        ...
                        $restoreCriteria = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.ItemPathBasedRestoreCriteria]::new()
                ...
                elseif($ContainersList.length -gt 0){
                    for($i = 0; $i -lt $ContainersList.length; $i++){
                        ...
                        $restoreCriteria = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.RangeBasedItemLevelRestoreCriteria]::new()
        ...
        if($PSBoundParameters.ContainsKey("SecretStoreURI"))
        {
            if($manifest.supportSecretStoreAuthentication -eq $true){
                ...
                $restoreRequest.RestoreTargetInfo.DatasourceAuthCredentials = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.SecretStoreBasedAuthCredentials]::new()
                $restoreRequest.RestoreTargetInfo.DatasourceAuthCredentials.ObjectType = "SecretStoreBasedAuthCredentials"
                $restoreRequest.RestoreTargetInfo.DatasourceAuthCredentials.SecretStoreResource =  [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.SecretStoreResource]::new()
