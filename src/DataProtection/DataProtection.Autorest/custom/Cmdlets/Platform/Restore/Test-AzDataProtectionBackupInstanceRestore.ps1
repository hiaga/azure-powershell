...
{   
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.IOperationJobExtendedInfo')]
    ...
    process
    {
        $Parameter = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.ValidateRestoreRequestObject]::new()
