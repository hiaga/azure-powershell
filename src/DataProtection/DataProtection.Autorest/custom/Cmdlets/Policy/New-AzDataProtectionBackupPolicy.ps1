function New-AzDataProtectionBackupPolicy
{
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.IBaseBackupPolicyResource')]
    ...
    process
    {
        ...
        $policyObject = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.BaseBackupPolicyResource]::new()
