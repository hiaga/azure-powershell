function New-AzDataProtectionBackupPolicy
{
    ...
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.IBaseBackupPolicyResource')]
    ...
    process
    {
        ...
        $policyObject = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.BaseBackupPolicyResource]::new()
