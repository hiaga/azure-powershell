function Edit-AzDataProtectionPolicyTagClientObject{
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.IBackupPolicy')]
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.IBackupPolicy]
        ${Policy},
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.IScheduleBasedBackupCriteria[]]
        ${Criteria}
    )
    ...
    process{
        ...
        if($backupRuleIndex -ne -1)
        {
            ...
            if($parameterSetName -eq "updateTag")
            {
                ...
                if($tagIndex -eq -1)
                {
                    $tagCriteria = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.TaggingCriteria]::new()
