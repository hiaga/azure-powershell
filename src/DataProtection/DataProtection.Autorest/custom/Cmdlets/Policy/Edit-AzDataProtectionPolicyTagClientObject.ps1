function Edit-AzDataProtectionPolicyTagClientObject{
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.IBackupPolicy')]
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.IBackupPolicy]
        ${Policy},
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.IScheduleBasedBackupCriteria[]]
        ${Criteria}
    )
    ...
    process{
        ...
        if($backupRuleIndex -ne -1)
        {
            ...
            if($parameterSetName -eq "updateTag")
            {
                ...
                if($tagIndex -eq -1)
                {
                    $tagCriteria = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.TaggingCriteria]::new()
