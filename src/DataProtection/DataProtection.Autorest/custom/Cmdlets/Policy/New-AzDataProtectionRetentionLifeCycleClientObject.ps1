function New-AzDataProtectionRetentionLifeCycleClientObject {
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.ISourceLifeCycle')]
    ...
    process {
        $lifeCycle = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.SourceLifeCycle]::new()
        ...
        {
            $targetCopySetting = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.TargetCopySetting]::new()
