function New-AzDataProtectionRetentionLifeCycleClientObject {
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.ISourceLifeCycle')]
    ...
    process {
        $lifeCycle = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.SourceLifeCycle]::new()
        ...
        {
            $targetCopySetting = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.TargetCopySetting]::new()
