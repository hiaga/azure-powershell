function New-AzDataProtectionPolicyTagCriteriaClientObject{
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.IScheduleBasedBackupCriteria')]
    ...
    process {
        $criteria = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.ScheduleBasedBackupCriteria]::new()
        ...
        if($DaysOfMonth -ne $null){
            ...
            Foreach($dayOfMonth in $DaysOfMonth)
            {
                if($dayOfMonth -match "^[\d]+$")
                {
                    ...
                    $day = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.Day]::new()
