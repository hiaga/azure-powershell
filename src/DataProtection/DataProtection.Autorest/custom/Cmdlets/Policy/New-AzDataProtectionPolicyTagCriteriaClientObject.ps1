function New-AzDataProtectionPolicyTagCriteriaClientObject{
	[OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.IScheduleBasedBackupCriteria')]
    ...
    process {
        $criteria = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.ScheduleBasedBackupCriteria]::new()
        ...
        if($DaysOfMonth -ne $null){
            ...
            Foreach($dayOfMonth in $DaysOfMonth)
            {
                if($dayOfMonth -match "^[\d]+$")
                {
                    ...
                    $day = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.Day]::new()
