...
function Edit-AzDataProtectionPolicyRetentionRuleClientObject {
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.ISourceLifeCycle[]]
        ${LifeCycles}
    )
    ...
    process {
        ...
        if($parameterSetName -eq "AddRetention"){
            ...
            if($retentionPolicyIndex -eq -1){
                ...
                $newRetentionRule = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.AzureRetentionRule]::new()
