...
function Edit-AzDataProtectionPolicyRetentionRuleClientObject {
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.ISourceLifeCycle[]]
        ${LifeCycles}
    )
    ...
    process {
        ...
        if($parameterSetName -eq "AddRetention"){
            ...
            if($retentionPolicyIndex -eq -1){
                ...
                $newRetentionRule = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.AzureRetentionRule]::new()
