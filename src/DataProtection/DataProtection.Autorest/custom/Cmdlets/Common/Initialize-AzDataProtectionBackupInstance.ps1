...
function Initialize-AzDataProtectionBackupInstance {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.IBackupInstanceResource')]
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.IBackupDatasourceParameters]
        ${BackupConfiguration}
    )
    ...
    process {
        ...
        $backupInstance = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.BackupInstance]::new()
        ...
        {            
            if($manifest.supportSecretStoreAuthentication -eq $true){
                ...
                $backupInstance.DatasourceAuthCredentials = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.SecretStoreBasedAuthCredentials]::new()
                $backupInstance.DatasourceAuthCredentials.ObjectType = "SecretStoreBasedAuthCredentials"
                $backupInstance.DatasourceAuthCredentials.SecretStoreResource =  [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.SecretStoreResource]::new()
        ...
        $backupInstanceResource = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.BackupInstanceResource]::new()
        ...
        {
            $operationalParam = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.AzureOperationalStoreParameters]::new()
