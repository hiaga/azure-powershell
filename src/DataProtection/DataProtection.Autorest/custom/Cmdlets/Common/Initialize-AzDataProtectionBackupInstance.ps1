...
function Initialize-AzDataProtectionBackupInstance {
    [OutputType('Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.IBackupInstanceResource')]
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.IBackupDatasourceParameters]
        ${BackupConfiguration}
    )
    ...
    process {
        ...
        $backupInstance = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.BackupInstance]::new()
        ...
        {            
            if($manifest.supportSecretStoreAuthentication -eq $true){
                ...
                $backupInstance.DatasourceAuthCredentials = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.SecretStoreBasedAuthCredentials]::new()
                $backupInstance.DatasourceAuthCredentials.ObjectType = "SecretStoreBasedAuthCredentials"
                $backupInstance.DatasourceAuthCredentials.SecretStoreResource =  [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.SecretStoreResource]::new()
        ...
        $backupInstanceResource = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.BackupInstanceResource]::new()
        ...
        {
            $operationalParam = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801Preview.AzureOperationalStoreParameters]::new()
