...
function New-AzDataProtectionBackupConfigurationClientObject{
    ...
    param(
        ...
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.NamespacedNameResource[]]
        ${BackupHookReference},
    ...
    process {        
        ...
        if($DatasourceType.ToString() -eq "AzureKubernetesService"){
            ...
            $dataSourceParam = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.KubernetesClusterBackupDatasourceParameters]::new()
        ...
        if($DatasourceType.ToString() -eq "AzureBlob"){
            $dataSourceParam = [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Api20230801.BlobBackupDatasourceParameters]::new()
