...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzDataProtectionBackupPolicy_UpdateViaIdentityBackupVault", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzDataProtectionBackupPolicy_UpdateViaIdentityBackupVault : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    if (BackupVaultInputObject?.Id != null)
                    {
                        ...
                        Parameter = await this.Client.BackupPoliciesGetViaIdentityWithResult(BackupVaultInputObject.Id, this, Pipeline);
                        this.UpdateParameter();
                        await this.Client.BackupPoliciesCreateOrUpdateViaIdentity(BackupVaultInputObject.Id, Parameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        Parameter = await this.Client.BackupPoliciesGetWithResult(BackupVaultInputObject.SubscriptionId ?? null, BackupVaultInputObject.ResourceGroupName ?? null, BackupVaultInputObject.VaultName ?? null, Name, this, Pipeline);
                        this.UpdateParameter();
                        await this.Client.BackupPoliciesCreateOrUpdate(BackupVaultInputObject.SubscriptionId ?? null, BackupVaultInputObject.ResourceGroupName ?? null, BackupVaultInputObject.VaultName ?? null, Name, Parameter, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzDataProtectionBackupPolicy_UpdateViaIdentityBackupVault" /> cmdlet
        /// class.
        /// </summary>
        public UpdateAzDataProtectionBackupPolicy_UpdateViaIdentityBackupVault()
        {
        ...
        private void UpdateParameter()
        {
            ...
            {
                this.Parameter = (Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IBaseBackupPolicyResource)(this.MyInvocation?.BoundParameters["Parameter"]);
            }
        }
