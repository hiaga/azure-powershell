...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataProtection/backupVaults/{vaultName}/backupResourceGuardProxies/{resourceGuardProxyName}"
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzDataProtectionResourceGuardMapping_UpdateViaIdentityBackupVaultExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzDataProtectionResourceGuardMapping_UpdateViaIdentityBackupVaultExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IResourceGuardProxyBaseResource _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.ResourceGuardProxyBaseResource();
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string LastUpdatedTime { get => _parametersBody.LastUpdatedTime ?? null; set => _parametersBody.LastUpdatedTime = value; }
        ...
        /// <summary>Resource Guard ARM Id to enable MUA protection for Backup Vault.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Resource Guard ARM Id to enable MUA protection for Backup Vault.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Category(global::Microsoft.Azure.PowerShell.Cmdlets.DataProtection.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Info(
        Required = false,
        ReadOnly = false,
        Description = @"Resource Guard ARM Id to enable MUA protection for Backup Vault.",
        SerializedName = @"resourceGuardResourceId",
        PossibleTypes = new [] { typeof(string) })]
        public string ResourceGuardId { get => _parametersBody.ResourceGuardId ?? null; set => _parametersBody.ResourceGuardId = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IResourceGuardOperationDetail[] ResourceGuardOperationDetail { get => _parametersBody.ResourceGuardOperationDetail?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.ResourceGuardOperationDetail = (value != null ? new System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IResourceGuardOperationDetail>(value) : null); }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        this.BackupVaultInputObject.Id += $"/backupResourceGuardProxies/{(global::System.Uri.EscapeDataString(this.ResourceGuardProxyName.ToString()))}";
                        _parametersBody = await this.Client.DppResourceGuardProxyGetViaIdentityWithResult(BackupVaultInputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.DppResourceGuardProxyCreateOrUpdateViaIdentity(BackupVaultInputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        _parametersBody = await this.Client.DppResourceGuardProxyGetWithResult(BackupVaultInputObject.SubscriptionId ?? null, BackupVaultInputObject.ResourceGroupName ?? null, BackupVaultInputObject.VaultName ?? null, ResourceGuardProxyName, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.DppResourceGuardProxyCreateOrUpdate(BackupVaultInputObject.SubscriptionId ?? null, BackupVaultInputObject.ResourceGroupName ?? null, BackupVaultInputObject.VaultName ?? null, ResourceGuardProxyName, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGuardProxyName=ResourceGuardProxyName})
                    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzDataProtectionResourceGuardMapping_UpdateViaIdentityBackupVaultExpanded"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzDataProtectionResourceGuardMapping_UpdateViaIdentityBackupVaultExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ResourceGuardId")))
            {
                this.ResourceGuardId = (string)(this.MyInvocation?.BoundParameters["ResourceGuardId"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ResourceGuardOperationDetail")))
            {
                this.ResourceGuardOperationDetail = (Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IResourceGuardOperationDetail[])(this.MyInvocation?.BoundParameters["ResourceGuardOperationDetail"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("LastUpdatedTime")))
            {
                this.LastUpdatedTime = (string)(this.MyInvocation?.BoundParameters["LastUpdatedTime"]);
            }
