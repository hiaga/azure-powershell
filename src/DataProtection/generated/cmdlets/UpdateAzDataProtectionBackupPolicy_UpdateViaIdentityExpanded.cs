...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsData.Update, @"AzDataProtectionBackupPolicy_UpdateViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class UpdateAzDataProtectionBackupPolicy_UpdateViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.IContext
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IBaseBackupPolicyResource _parametersBody = new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.BaseBackupPolicyResource();
        ...
        public string[] DatasourceType { get => _parametersBody.DatasourceType?.ToArray() ?? null /* fixedArrayOf */; set => _parametersBody.DatasourceType = (value != null ? new System.Collections.Generic.List<string>(value) : null); }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        _parametersBody = await this.Client.BackupPoliciesGetViaIdentityWithResult(InputObject.Id, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.BackupPoliciesCreateOrUpdateViaIdentity(InputObject.Id, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        if (null == InputObject.BackupPolicyName)
                        {
                            ThrowTerminatingError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception("InputObject has null value for InputObject.BackupPolicyName"),string.Empty, global::System.Management.Automation.ErrorCategory.InvalidArgument, InputObject) );
                        }
                        _parametersBody = await this.Client.BackupPoliciesGetWithResult(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, InputObject.BackupPolicyName ?? null, this, Pipeline);
                        this.Update_parametersBody();
                        await this.Client.BackupPoliciesCreateOrUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.VaultName ?? null, InputObject.BackupPolicyName ?? null, _parametersBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAzDataProtectionBackupPolicy_UpdateViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public UpdateAzDataProtectionBackupPolicy_UpdateViaIdentityExpanded()
        {
        ...
        {
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("DatasourceType")))
            {
                this.DatasourceType = (string[])(this.MyInvocation?.BoundParameters["DatasourceType"]);
            }
            if ((bool)(true == this.MyInvocation?.BoundParameters.ContainsKey("ObjectType")))
            {
                this.ObjectType = (string)(this.MyInvocation?.BoundParameters["ObjectType"]);
            }
        }
