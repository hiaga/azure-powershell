...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models
{
    ...
    public partial class BackupInstance
    {
        ...
        internal BackupInstance(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
            ...
            {_friendlyName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("friendlyName"), out var __jsonFriendlyName) ? (string)__jsonFriendlyName : (string)_friendlyName;}
            {_dataSourceInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("dataSourceInfo"), out var __jsonDataSourceInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.Datasource.FromJson(__jsonDataSourceInfo) : _dataSourceInfo;}
            {_dataSourceSetInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("dataSourceSetInfo"), out var __jsonDataSourceSetInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.DatasourceSet.FromJson(__jsonDataSourceSetInfo) : _dataSourceSetInfo;}
            {_policyInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("policyInfo"), out var __jsonPolicyInfo) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.PolicyInfo.FromJson(__jsonPolicyInfo) : _policyInfo;}
            {_protectionStatus = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("protectionStatus"), out var __jsonProtectionStatus) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.ProtectionStatusDetails.FromJson(__jsonProtectionStatus) : _protectionStatus;}
            {_currentProtectionState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("currentProtectionState"), out var __jsonCurrentProtectionState) ? (string)__jsonCurrentProtectionState : (string)_currentProtectionState;}
            {_protectionErrorDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("protectionErrorDetails"), out var __jsonProtectionErrorDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.UserFacingError.FromJson(__jsonProtectionErrorDetails) : _protectionErrorDetail;}
            ...
            {_datasourceAuthCredentials = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("datasourceAuthCredentials"), out var __jsonDatasourceAuthCredentials) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.AuthCredentials.FromJson(__jsonDatasourceAuthCredentials) : _datasourceAuthCredentials;}
            {_validationType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("validationType"), out var __jsonValidationType) ? (string)__jsonValidationType : (string)_validationType;}
            {_identityDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject>("identityDetails"), out var __jsonIdentityDetails) ? Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IdentityDetails.FromJson(__jsonIdentityDetails) : _identityDetail;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IBackupInstance.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IBackupInstance.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IBackupInstance FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
