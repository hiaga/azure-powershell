...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models
{
    ...
    public partial class RecoveryPointsFilters
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IRecoveryPointsFilters.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IRecoveryPointsFilters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IRecoveryPointsFilters FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
        ...
        internal RecoveryPointsFilters(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
            ...
            {_restorePointDataStoreId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("restorePointDataStoreId"), out var __jsonRestorePointDataStoreId) ? (string)__jsonRestorePointDataStoreId : (string)_restorePointDataStoreId;}
            {_isVisible = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonBoolean>("isVisible"), out var __jsonIsVisible) ? (bool?)__jsonIsVisible : _isVisible;}
            {_startDate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("startDate"), out var __jsonStartDate) ? (string)__jsonStartDate : (string)_startDate;}
            {_endDate = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("endDate"), out var __jsonEndDate) ? (string)__jsonEndDate : (string)_endDate;}
            {_extendedInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonBoolean>("extendedInfo"), out var __jsonExtendedInfo) ? (bool?)__jsonExtendedInfo : _extendedInfo;}
            {_restorePointState = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("restorePointState"), out var __jsonRestorePointState) ? (string)__jsonRestorePointState : (string)_restorePointState;}
            AfterFromJson(json);
        }
