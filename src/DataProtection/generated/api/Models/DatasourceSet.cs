...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models
{
    ...
    public partial class DatasourceSet :
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDatasourceSet,
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDatasourceSetInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IBaseResourceProperties Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDatasourceSetInternal.ResourceProperty { get => (this._resourceProperty = this._resourceProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.BaseResourceProperties()); set { {_resourceProperty = value;} } }

        /// <summary>Internal Acessors for ResourcePropertyObjectType</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IDatasourceSetInternal.ResourcePropertyObjectType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IBaseResourcePropertiesInternal)ResourceProperty).ObjectType; set => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IBaseResourcePropertiesInternal)ResourceProperty).ObjectType = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IBaseResourceProperties _resourceProperty;

        /// <summary>Properties specific to data source set</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IBaseResourceProperties ResourceProperty { get => (this._resourceProperty = this._resourceProperty ?? new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.BaseResourceProperties()); set => this._resourceProperty = value; }

        /// <summary>Type of the specific object - used for deserializing</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Origin(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.PropertyOrigin.Inlined)]
        public string ResourcePropertyObjectType { get => ((Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IBaseResourcePropertiesInternal)ResourceProperty).ObjectType; }
...

    {
        ...
        string ResourceName { get; set; }
        /// <summary>Properties specific to data source set</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IBaseResourceProperties ResourceProperty { get; set; }
        /// <summary>Type of the specific object - used for deserializing</summary>
