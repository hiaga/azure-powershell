...
namespace Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models
{
    ...
    public partial class AzureBackupDiscreteRecoveryPoint
    {
        ...
        internal AzureBackupDiscreteRecoveryPoint(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonObject json)
        {
            ...
            __azureBackupRecoveryPoint = new Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.AzureBackupRecoveryPoint(json);
            ...
            {_recoveryPointDataStoresDetail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonArray>("recoveryPointDataStoresDetails"), out var __jsonRecoveryPointDataStoresDetails) ? If( __jsonRecoveryPointDataStoresDetails as Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<System.Collections.Generic.List<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IRecoveryPointDataStoreDetails>>(()=> global::System.Linq.Enumerable.ToList(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IRecoveryPointDataStoreDetails) (Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.RecoveryPointDataStoreDetails.FromJson(__u) )) ))() : null : _recoveryPointDataStoresDetail;}
            ...
            {_policyVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("policyVersion"), out var __jsonPolicyVersion) ? (string)__jsonPolicyVersion : (string)_policyVersion;}
            {_recoveryPointId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("recoveryPointId"), out var __jsonRecoveryPointId) ? (string)__jsonRecoveryPointId : (string)_recoveryPointId;}
            {_recoveryPointType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("recoveryPointType"), out var __jsonRecoveryPointType) ? (string)__jsonRecoveryPointType : (string)_recoveryPointType;}
            {_retentionTagName = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("retentionTagName"), out var __jsonRetentionTagName) ? (string)__jsonRetentionTagName : (string)_retentionTagName;}
            {_retentionTagVersion = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonString>("retentionTagVersion"), out var __jsonRetentionTagVersion) ? (string)__jsonRetentionTagVersion : (string)_retentionTagVersion;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IAzureBackupDiscreteRecoveryPoint.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IAzureBackupDiscreteRecoveryPoint.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Models.IAzureBackupDiscreteRecoveryPoint FromJson(Microsoft.Azure.PowerShell.Cmdlets.DataProtection.Runtime.Json.JsonNode node)
        {
