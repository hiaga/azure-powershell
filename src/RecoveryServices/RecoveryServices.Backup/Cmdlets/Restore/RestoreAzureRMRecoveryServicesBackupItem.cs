        ...
        public override void ExecuteCmdlet()
        {
            ExecutionBlock(() =>
            {
                ...
                if (DiskEncryptionSetId != null)
                {
                    ...
                    IaasVMRecoveryPoint rp = rpResponse.Properties as IaasVMRecoveryPoint;
                    bool isManagedVM = (bool)rp.IsManagedVirtualMachine;
                    bool isBitlockedVM = (bool)rp.IsSourceVMEncrypted;
                    ...
                    if ((vaultEncryptionSettings.Properties.EncryptionAtRestType == "CustomerManaged") && isManagedVM && !(isBitlockedVM))
                    {
