@{
  ...
  FunctionsToExport = 'Edit-AzRecoveryServicesBackupRetentionPolicyClientObject', 'Edit-AzRecoveryServicesBackupSchedulePolicyClientObject', 'Get-AzRecoveryServicesBackupContainer', 'Get-AzRecoveryServicesBackupItem', 'Get-AzRecoveryServicesBackupPolicy', 'Get-AzRecoveryServicesBackupProtectableItem', 'Get-AzRecoveryServicesPolicyTemplate', 'New-AzRecoveryServicesBackupPolicy', 'Register-AzRecoveryServicesBackupContainer', 'Remove-AzRecoveryServicesBackupPolicy', '*'
  AliasesToExport = '*'
  PrivateData = @{
    PSData = @{
