...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesjobdetail
schema: 2.0.0
---

# Get-AzRecoveryServicesJobDetail
...
### Get (Default)
```
Get-AzRecoveryServicesJobDetail -JobName <String> -ResourceGroupName <String> -VaultName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRecoveryServicesJobDetail -InputObject <IRecoveryServicesIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
