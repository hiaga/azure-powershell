...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/new-azrecoveryservicesitemlevelrecoveryconnection
schema: 2.0.0
---

# New-AzRecoveryServicesItemLevelRecoveryConnection
...
```
New-AzRecoveryServicesItemLevelRecoveryConnection -ContainerName <String> -FabricName <String>
 -ProtectedItemName <String> -RecoveryPointId <String> -ResourceGroupName <String> -VaultName <String>
 [-SubscriptionId <String>] [-ETag <String>] [-Location <String>] [-ObjectType <String>] [-Tag <Hashtable>]
...
New-AzRecoveryServicesItemLevelRecoveryConnection -ContainerName <String> -FabricName <String>
 -ProtectedItemName <String> -RecoveryPointId <String> -ResourceGroupName <String> -VaultName <String>
 -Parameter <IIlrRequestResource> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-AzRecoveryServicesItemLevelRecoveryConnection -InputObject <IRecoveryServicesIdentity>
 -Parameter <IIlrRequestResource> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### ProvisionViaIdentityExpanded
```
New-AzRecoveryServicesItemLevelRecoveryConnection -InputObject <IRecoveryServicesIdentity> [-ETag <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IIlrRequestResource
...
### -RecoveryPointId
Recovery point ID which represents backed up data.
iSCSI connection will be provisioned
...
### Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IIlrRequestResource
...
PARAMETER <IIlrRequestResource>: Parameters to Provision ILR API.
