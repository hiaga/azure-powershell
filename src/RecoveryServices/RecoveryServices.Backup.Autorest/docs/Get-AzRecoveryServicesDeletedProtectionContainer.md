...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesdeletedprotectioncontainer
schema: 2.0.0
---
...
```
Get-AzRecoveryServicesDeletedProtectionContainer -ResourceGroupName <String> -VaultName <String>
