...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesbackupengine
schema: 2.0.0
---

# Get-AzRecoveryServicesBackupEngine
...
### List (Default)
```
Get-AzRecoveryServicesBackupEngine -ResourceGroupName <String> -VaultName <String>
...
### Get
```
Get-AzRecoveryServicesBackupEngine -Name <String> -ResourceGroupName <String> -VaultName <String>
 [-SubscriptionId <String[]>] [-Filter <String>] [-SkipToken <String>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### GetViaIdentity
```
Get-AzRecoveryServicesBackupEngine -InputObject <IRecoveryServicesIdentity> [-Filter <String>]
