...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/remove-azrecoveryservicesprivateendpointconnection
schema: 2.0.0
---

# Remove-AzRecoveryServicesPrivateEndpointConnection
...
### Delete (Default)
```
Remove-AzRecoveryServicesPrivateEndpointConnection -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzRecoveryServicesPrivateEndpointConnection -InputObject <IRecoveryServicesIdentity>
