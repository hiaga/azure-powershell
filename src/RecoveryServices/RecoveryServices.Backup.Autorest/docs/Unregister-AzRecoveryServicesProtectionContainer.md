...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/unregister-azrecoveryservicesprotectioncontainer
schema: 2.0.0
---

# Unregister-AzRecoveryServicesProtectionContainer
...
### Unregister (Default)
```
Unregister-AzRecoveryServicesProtectionContainer -ContainerName <String> -FabricName <String>
...
```
Unregister-AzRecoveryServicesProtectionContainer -InputObject <IRecoveryServicesIdentity>
