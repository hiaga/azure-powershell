...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesprotectioncontainer
schema: 2.0.0
---

# Get-AzRecoveryServicesProtectionContainer
...
### Get (Default)
```
Get-AzRecoveryServicesProtectionContainer -ContainerName <String> -FabricName <String>
...
### GetViaIdentity
```
Get-AzRecoveryServicesProtectionContainer -InputObject <IRecoveryServicesIdentity>
