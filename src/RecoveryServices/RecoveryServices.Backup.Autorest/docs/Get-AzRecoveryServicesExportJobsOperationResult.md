...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesexportjobsoperationresult
schema: 2.0.0
---

# Get-AzRecoveryServicesExportJobsOperationResult
...
### Get (Default)
```
Get-AzRecoveryServicesExportJobsOperationResult -OperationId <String> -ResourceGroupName <String>
 -VaultName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRecoveryServicesExportJobsOperationResult -InputObject <IRecoveryServicesIdentity>
...
### Microsoft.Azure.PowerShell.Cmdlets.RecoveryServices.Models.Api20230201.IOperationResultInfoBaseResource
