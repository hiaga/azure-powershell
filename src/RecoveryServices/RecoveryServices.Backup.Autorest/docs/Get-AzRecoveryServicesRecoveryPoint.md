...
### List (Default)
```
Get-AzRecoveryServicesRecoveryPoint -ContainerName <String> -FabricName <String> -ProtectedItemName <String>
...
### Get
```
Get-AzRecoveryServicesRecoveryPoint -ContainerName <String> -FabricName <String> -Id <String>
...
### GetViaIdentity
```
Get-AzRecoveryServicesRecoveryPoint -InputObject <IRecoveryServicesIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
