...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesbackupresourceencryptionconfig
schema: 2.0.0
---

# Get-AzRecoveryServicesBackupResourceEncryptionConfig
...
### Get (Default)
```
Get-AzRecoveryServicesBackupResourceEncryptionConfig -ResourceGroupName <String> -VaultName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRecoveryServicesBackupResourceEncryptionConfig -InputObject <IRecoveryServicesIdentity>
