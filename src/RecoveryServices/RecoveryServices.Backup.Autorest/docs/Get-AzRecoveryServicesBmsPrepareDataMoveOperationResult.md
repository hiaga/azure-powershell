...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesbmspreparedatamoveoperationresult
schema: 2.0.0
---

# Get-AzRecoveryServicesBmsPrepareDataMoveOperationResult
...
### Get (Default)
```
Get-AzRecoveryServicesBmsPrepareDataMoveOperationResult -OperationId <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzRecoveryServicesBmsPrepareDataMoveOperationResult -InputObject <IRecoveryServicesIdentity>
