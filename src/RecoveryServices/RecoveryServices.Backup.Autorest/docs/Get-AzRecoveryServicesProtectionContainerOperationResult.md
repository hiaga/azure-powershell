...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesprotectioncontaineroperationresult
schema: 2.0.0
---

# Get-AzRecoveryServicesProtectionContainerOperationResult
...
### Get (Default)
```
Get-AzRecoveryServicesProtectionContainerOperationResult -ContainerName <String> -FabricName <String>
 -OperationId <String> -ResourceGroupName <String> -VaultName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRecoveryServicesProtectionContainerOperationResult -InputObject <IRecoveryServicesIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```
