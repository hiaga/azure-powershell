...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesvalidateoperationstatuses
schema: 2.0.0
---

# Get-AzRecoveryServicesValidateOperationStatuses
...
### Get (Default)
```
Get-AzRecoveryServicesValidateOperationStatuses -OperationId <String> -ResourceGroupName <String>
 -VaultName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRecoveryServicesValidateOperationStatuses -InputObject <IRecoveryServicesIdentity>
