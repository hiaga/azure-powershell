...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesprotecteditemoperationresult
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzRecoveryServicesProtectedItemOperationResult -ContainerName <String> -FabricName <String>
...
### GetViaIdentity
```
Get-AzRecoveryServicesProtectedItemOperationResult -InputObject <IRecoveryServicesIdentity>
