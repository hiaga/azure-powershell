...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/new-azrecoveryservicesprotectionpolicy
schema: 2.0.0
---
...
```
New-AzRecoveryServicesProtectionPolicy -PolicyName <String> -ResourceGroupName <String> -VaultName <String>
...
### CreateViaIdentity
```
New-AzRecoveryServicesProtectionPolicy -InputObject <IRecoveryServicesIdentity>
