...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesprivateendpointconnection
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzRecoveryServicesPrivateEndpointConnection -Name <String> -ResourceGroupName <String> -VaultName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRecoveryServicesPrivateEndpointConnection -InputObject <IRecoveryServicesIdentity>
