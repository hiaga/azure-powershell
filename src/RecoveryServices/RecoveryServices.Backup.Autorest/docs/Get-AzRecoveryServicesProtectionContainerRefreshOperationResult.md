...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesprotectioncontainerrefreshoperationresult
schema: 2.0.0
---

# Get-AzRecoveryServicesProtectionContainerRefreshOperationResult
...
### Get (Default)
```
Get-AzRecoveryServicesProtectionContainerRefreshOperationResult -FabricName <String> -OperationId <String>
...
### GetViaIdentity
```
Get-AzRecoveryServicesProtectionContainerRefreshOperationResult -InputObject <IRecoveryServicesIdentity>
