...
New-AzRecoveryServicesBackupPolicy -Policy <IProtectionPolicy> -PolicyName <String>
 ...
 [-TieringMode <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```powershell
$pol1=Get-AzRecoveryServicesPolicyTemplate -DatasourceType AzureVM
New-AzRecoveryServicesBackupPolicy -ResourceGroupName arohijain-rg -VaultName arohijain-vault -Policy $pol1 -PolicyName tiertest5 -MoveToArchiveTier $true -TierAfterDuration 54 -TieringMode TierAfter
$pol1.TieringPolicy.AdditionalProperties.ArchivedRP | fl
```
...
New-AzRecoveryServicesBackupPolicy -ResourceGroupName arohijain-rg -VaultName arohijain-vault -Policy $pol1 -PolicyName tiertest6 -MoveToArchiveTier $true -TierAfterDuration 64 -TieringMode TierAfter
