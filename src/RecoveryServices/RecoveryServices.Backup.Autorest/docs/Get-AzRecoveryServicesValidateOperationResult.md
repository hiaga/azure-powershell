...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesvalidateoperationresult
schema: 2.0.0
---

# Get-AzRecoveryServicesValidateOperationResult
...
### Get (Default)
```
Get-AzRecoveryServicesValidateOperationResult -OperationId <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzRecoveryServicesValidateOperationResult -InputObject <IRecoveryServicesIdentity>
