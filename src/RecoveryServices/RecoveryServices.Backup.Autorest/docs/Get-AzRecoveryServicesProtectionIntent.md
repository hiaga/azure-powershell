...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/get-azrecoveryservicesprotectionintent
schema: 2.0.0
---

# Get-AzRecoveryServicesProtectionIntent
...
### Get (Default)
```
Get-AzRecoveryServicesProtectionIntent -FabricName <String> -IntentObjectName <String>
...
### GetViaIdentity
```
Get-AzRecoveryServicesProtectionIntent -InputObject <IRecoveryServicesIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
