...
online version: https://docs.microsoft.com/powershell/module/az.recoveryservices/export-azrecoveryservicesjob
schema: 2.0.0
---

# Export-AzRecoveryServicesJob
...
### Export (Default)
```
Export-AzRecoveryServicesJob -ResourceGroupName <String> -VaultName <String> [-SubscriptionId <String>]
 [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ExportViaIdentity
```
Export-AzRecoveryServicesJob -InputObject <IRecoveryServicesIdentity> [-Filter <String>]
