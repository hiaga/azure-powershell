...
namespace Microsoft.Azure.Commands.RecoveryServices
{
    ...
    public partial class PSRecoveryServicesClient
    {
        ...
        {
            GetRecoveryServicesBackupClient.BackupResourceStorageConfigsCRR.UpdateWithHttpMessagesAsync(
        ...
        public void PatchVaultStorageConfigProperties(string resouceGroupName, string vaultName,
            BackupResourceConfigResource backupStorageConfig)
        {
            GetRecoveryServicesBackupClient.BackupResourceStorageConfigsCRR.PatchWithHttpMessagesAsync(
                vaultName, resouceGroupName, backupStorageConfig, GetRequestHeaders());
        }
        ...
        {
            return GetRecoveryServicesBackupClient.BackupResourceStorageConfigsCRR.GetWithHttpMessagesAsync(
